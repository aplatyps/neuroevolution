...
function newSols = doDifferentialNet(inSols,memParams)
   newSols = [];
   numPat = memParams.numPat;
   
   disp('[12/03/13] Network version of differential evolution not implemented yet.');
...
%    while (li < numSols) && (numDone < memParams.maxDESol)

...
% 0 - does not exist
% 1 - exists
function [cost costTerms evalParams data funcStat errPat] = evalKPH2PR1ccEuclidDist(aSolRaw,data)
...
% Computer Iris error
%[error errPat] = compIrisErrPat1(netKPH2,data);
[error errPat maxOutPat] = compEuclidDistErrPat2(netKPH2,data);
cost = error;
